...
// import { HERO_CONFIG } from '../config'; // REMOVED
import { useContent } from '../contexts/ContentContext'; // ADDED
...
// --- TYPEWRITER HOOK (Enabled for Mobile now) ---
const useTypewriter = (words: string[], typeSpeed = 150, deleteSpeed = 100, pauseDuration = 2000) => {
  ...
  useEffect(() => {
    ...
    // Mobile check removed to enable animation on all devices as requested
...
const DefaultHeroLayout: React.FC<HeroProps> = ({ onNavigate, onOpenChat }) => {
  const { content } = useContent(); // CONSUME CONTEXT
  ...
  return (
    <section className="relative min-h-screen flex flex-col pt-28 md:pt-32 pb-10 overflow-hidden font-sans">
      <SEO 
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-50 border border-primary-100 text-primary-700 text-[10px] md:text-xs font-bold tracking-wide uppercase mb-6 md:mb-8 shadow-sm"
            >
            ...
            <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-gray-900 leading-[1.15] mb-4 md:mb-6 tracking-tight relative z-20">
              ...
              <div className="block md:inline-block relative w-full md:w-auto md:min-w-[400px] text-center md:text-left align-top cursor-default h-[1.15em] mt-1 md:mt-0">
            ...
            >
              <Button 
                ...
                onClick={onOpenChat}
                className="shadow-xl shadow-primary-600/20 w-full sm:w-auto min-h-[50px]"
              >
              ...
              <Button 
                ...
                className="bg-white/80 backdrop-blur-sm hover:bg-white w-full sm:w-auto min-h-[50px]"
              >
          ...
          {/* CODE BLOCK AREA - ANIMATED FOR ALL DEVICES */}
          <div className="flex-1 w-full flex justify-center relative min-h-[300px] lg:min-h-[400px] items-center mt-8 lg:mt-0 px-4">
             ...
             <div className="absolute top-10 right-10 w-48 h-48 md:w-64 md:h-64 bg-primary-500/20 rounded-full blur-[60px] md:blur-[80px] -z-10"></div>
          </div>
        </div>
